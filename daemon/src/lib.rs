...
pub static DBUS_NAME: &str = "com.PlayNux.NuxUpgrade";
pub static DBUS_PATH: &str = "/com/PlayNux/NuxUpgrade";
pub static DBUS_IFACE: &str = "com.PlayNux.NuxUpgrade";

pub const DEVELOPMENT_RELEASE_FILE: &str = "/etc/nux-upgrade/devel";

pub const VAR_LIB_DIR: &str = "/var/lib/nux-upgrade";
pub const TRANSITIONAL_SNAPS: &str = "/var/lib/nux-upgrade/transitional_snaps";
pub const RESTART_SCHEDULED: &str = "/var/lib/nux-upgrade/restarting";
